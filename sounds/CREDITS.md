...
The `sfx/` group has its own table in [`sfx/CREDITS.md`](../sfx/CREDITS.md) —
112 rows would swamp this file. Every clip there is CC0 or public domain, and
none require attribution.
